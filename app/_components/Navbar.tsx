...
function Navbar() {
  return (
    <header className="w-[85%] mx-auto py-8 font-semibold tracking-wider text-primary dark:text-secondary  md:border-b border-b-secondary dark:border-b-quaternary">
